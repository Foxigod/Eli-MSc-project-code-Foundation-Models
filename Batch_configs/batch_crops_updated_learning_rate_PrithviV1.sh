...
log_file="${log_dir}/learning_rate_crops_updated_PrithviV1.log"
...
for lr in "${learning_rates[@]}"; do
    for seed in "${seeds[@]}"; do
        ...
        output=$(sbatch --job-name="lr_${lr}__seed_${seed}_crops_updated_PrithviV1" ./submit_ViT-B_sen4map-crops-updated_bs30_crop15_resize224_patch16.sh \
