...
log_file="${log_dir}/data_efficiency_crops_updated_ViTL-fp32.log"
...
for train_frac in "${train_fractions[@]}"; do
    for seed in "${seeds[@]}"; do
        ...
        output=$(sbatch --job-name="trfrac_${train_frac}__seed_${seed}_crops_updated_ViTL-fp32" ./submit_ViT-L-fp32_sen4map-crops-updated_bs10_crop15_resize224_patch16.sh \
