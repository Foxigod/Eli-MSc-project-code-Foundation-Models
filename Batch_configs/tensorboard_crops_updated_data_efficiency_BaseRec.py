...
log_file = Path("./logs_batched/data_efficiency_crops_updated_BaseRec_10seeds.log")
...
names = {
    "val/Weighted_Multiclass_F1_Score": {"title":"Data Efficiency on Baseline Recreation model", "y-label":"Val F1 Score"},
    "val/Classwise_F1_Score_0": {"title":"Cereals", "y-label":"Val F1 Score"},
    "val/Classwise_F1_Score_1": {"title":"Root Crops", "y-label":"Val F1 Score"},
    "val/Classwise_F1_Score_2": {"title":"Nonpermanent Industrial Crops", "y-label":"Val F1 Score"},
    "val/Classwise_F1_Score_3": {"title":"Dry Pulses, Vegetables and Flowers", "y-label":"Val F1 Score"},
    "val/Classwise_F1_Score_4": {"title":"Fodder Crops", "y-label":"Val F1 Score"},
    "val/Classwise_F1_Score_5": {"title":"Bareland", "y-label":"Val F1 Score"},
    "val/Classwise_F1_Score_6": {"title":"Woodland and Shrubland", "y-label":"Val F1 Score"},
    "val/Classwise_F1_Score_7": {"title":"Grassland", "y-label":"Val F1 Score"},
    # "val/Classwise_F1_Score_8": {"title":"Wetlands", "y-label":"Test F1 Score"}
}
