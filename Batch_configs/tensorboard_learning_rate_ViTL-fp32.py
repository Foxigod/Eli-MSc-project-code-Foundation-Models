...
log_file = Path("./logs_batched/learning_rate_ViTL-fp32_10seeds_without_highest.log")
# log_file = Path("./logs_batched/learning_rate_ViTL-fp32_10seeds.log")
...
names = {
    "val/Weighted_Multiclass_F1_Score": {"title": "ViT-L model HPO fine-tuning", "y-label": "Val F1 Score"},
    "val/Classwise_F1_Score_0": {"title": "ViT-L model on Artificial land", "y-label": "Val F1 Score"},
    "val/Classwise_F1_Score_1": {"title": "ViT-L model on Bareland", "y-label": "Val F1 Score"},
    "val/Classwise_F1_Score_2": {"title": "ViT-L model on Grassland", "y-label": "Val F1 Score"},
    "val/Classwise_F1_Score_3": {"title": "ViT-L model on Cropland", "y-label": "Val F1 Score"},
    "val/Classwise_F1_Score_4": {"title": "ViT-L model on Broadleaves", "y-label": "Val F1 Score"},
    "val/Classwise_F1_Score_5": {"title": "ViT-L model on Conifers", "y-label": "Val F1 Score"},
    "val/Classwise_F1_Score_6": {"title": "ViT-L model on Shrubland", "y-label": "Val F1 Score"},
    "val/Classwise_F1_Score_7": {"title": "ViT-L model on Water", "y-label": "Val F1 Score"},
    "val/Classwise_F1_Score_8": {"title": "ViT-L model on Wetlands", "y-label": "Val F1 Score"},
}
