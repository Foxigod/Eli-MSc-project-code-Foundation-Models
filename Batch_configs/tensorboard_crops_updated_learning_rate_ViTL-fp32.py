...
log_file = Path("./logs_batched/learning_rate_crops_updated_ViTL-fp32_withoutHighest_10seeds.log")
...
names = {
    ...
    "val/Classwise_F1_Score_0": {"title":"ViT-L model on Cereals", "y-label":"Val F1 Score"},
    "val/Classwise_F1_Score_1": {"title":"ViT-L model on Root Crops", "y-label":"Val F1 Score"},
    "val/Classwise_F1_Score_2": {"title":"ViT-L model on Nonpermanent Industrial Crops", "y-label":"Val F1 Score"},
    "val/Classwise_F1_Score_3": {"title":"ViT-L model on Dry Pulses, Vegetables and Flowers", "y-label":"Val F1 Score"},
    "val/Classwise_F1_Score_4": {"title":"ViT-L model on Fodder Crops", "y-label":"Val F1 Score"},
    "val/Classwise_F1_Score_5": {"title":"ViT-L model on Bareland", "y-label":"Val F1 Score"},
    "val/Classwise_F1_Score_6": {"title":"ViT-L model on Woodland and Shrubland", "y-label":"Val F1 Score"},
    "val/Classwise_F1_Score_7": {"title":"ViT-L model on Grassland", "y-label":"Val F1 Score"},
}
