...
log_file="${log_dir}/learning_rate_crops_updated_ViTh.log"
...
for lr in "${learning_rates[@]}"; do
    for seed in "${seeds[@]}"; do
        ...
        output=$(sbatch --job-name="lr_${lr}__seed_${seed}_crops_updated_ViTh" ./submit_ViT-h_sen4map-crops-updated_bs4_crop15_resize224_patch14.sh \
