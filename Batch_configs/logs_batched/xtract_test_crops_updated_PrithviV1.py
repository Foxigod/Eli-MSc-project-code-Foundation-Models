...
TEST_LOGS = Path("./test_data_efficiency_crops_updated_PrithviV1_10seeds.log")
...
interest = {
    "test/Classwise_F1_Score_0":"Cereals",
    "test/Classwise_F1_Score_1":"Root Crops",
    "test/Classwise_F1_Score_2":"Non-permanent Industrial Crops",
    "test/Classwise_F1_Score_3":"Dry pulses, Vegetables & Flowers",
    "test/Classwise_F1_Score_4":"Fodder Crops",
    "test/Classwise_F1_Score_5":"Bareland",
    "test/Classwise_F1_Score_6":"Woodland & Shrubland",
    "test/Classwise_F1_Score_7":"Grassland",
...
with open(XTRACT_OUTFILE, "w") as out:
    for fraction in file_metrics_per_fraction.keys():
        ...
        for metric_key, metric_name in interest.items():
            ...
            print(f"{metric_name:<32} = {interquartile_mean(data):.3f},   ({conf_low:.3f}, {conf_high:.3f})", file=out)
        print(file=out)
'''
with open(XTRACT_OUTFILE, "w") as out:
    for fraction in file_metrics_per_fraction.keys():
