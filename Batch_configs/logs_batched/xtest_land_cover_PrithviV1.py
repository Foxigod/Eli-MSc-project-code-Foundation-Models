...
SEEDS_FILE = Path("./data_efficiency_PrithviV1_10seeds.log")
SUBMISSION_FILE = Path("../submit_test_ViT-B_sen4map_bs30_crop15_resize224_patch16.sh")
BASH_FILE = Path("./xtest_dataeff_landcover_PrithviV1.sh")
