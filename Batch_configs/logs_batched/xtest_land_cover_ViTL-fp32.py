...
SEEDS_FILE = Path("./data_efficiency_ViTL-fp32_10seeds.log")
SUBMISSION_FILE = Path("../submit_test_ViT-L-fp32_sen4map_bs10_crop15_resize224_patch16.sh")
BASH_FILE = Path("./xtest_dataeff_landcover_ViTL-fp32.sh")
