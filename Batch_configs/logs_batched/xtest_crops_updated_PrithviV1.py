...
SEEDS_FILE = Path("./data_efficiency_crops_updated_PrithviV1_10seeds.log")
SUBMISSION_FILE = Path("../submit_test_ViT-B_sen4map-crops-updated_bs30_crop15_resize224_patch16.sh")
BASH_FILE = Path("./xtest_dataeff_cropsUpdated_PrithviV1.sh")
