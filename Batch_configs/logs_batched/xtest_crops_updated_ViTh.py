...
SEEDS_FILE = Path("./data_efficiency_crops_updated_ViTh_10seeds.log")
SUBMISSION_FILE = Path("../submit_test_ViT-h_sen4map-crops-updated_bs4_crop15_resize224_patch14.sh")
BASH_FILE = Path("./xtest_dataeff_cropsUpdated_ViTh.sh")
