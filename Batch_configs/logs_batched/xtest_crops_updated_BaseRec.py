...
SUBMISSION_FILE = Path("../submit_test_sen4map-crops-updated_bs80_crop15_patch3_timepatch3_Recreate_baseline.sh")
BASH_FILE = Path("./xtest_dataeff_cropsUpdated_BaseRec.sh")
