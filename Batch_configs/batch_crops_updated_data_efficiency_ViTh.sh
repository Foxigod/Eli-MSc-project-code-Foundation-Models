...
log_file="${log_dir}/data_efficiency_crops_updated_ViTh_repeatfailed.log"
...
for train_frac in "${train_fractions[@]}"; do
    for seed in "${seeds[@]}"; do
        ...
        output=$(sbatch --job-name="trfrac_${train_frac}__seed_${seed}_crops_updated_ViTh" ./submit_ViT-h_sen4map-crops-updated_bs4_crop15_resize224_patch14.sh \
