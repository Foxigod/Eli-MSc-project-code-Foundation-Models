...
log_file = Path("./logs_batched/data_efficiency_crops_updated_PrithviV1_10seeds.log")
...
names = {
    "val/Weighted_Multiclass_F1_Score": {"title":"Data Efficiency on PrithviOS", "y-label":"Val F1 Score"},
