...
log_file = Path("./logs_batched/data_efficiency_crops_updated_ViTL-fp32_10seeds.log")
...
names = {
    "val/Weighted_Multiclass_F1_Score": {"title":"Data Efficiency on ViT-L variant model", "y-label":"Val F1 Score"},
