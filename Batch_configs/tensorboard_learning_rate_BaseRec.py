...
log_file = Path("./logs_batched/learning_rate_BaseRec_10seeds.log")
...
names = {
    "val/Weighted_Multiclass_F1_Score": {"title": "Baseline Recreation model HPO fine-tuning", "y-label": "Val F1 Score"},
    "val/Classwise_F1_Score_0": {"title": "Baseline Recreation model on Artificial land", "y-label": "Val F1 Score"},
    "val/Classwise_F1_Score_1": {"title": "Baseline Recreation model on Bareland", "y-label": "Val F1 Score"},
    "val/Classwise_F1_Score_2": {"title": "Baseline Recreation model on Grassland", "y-label": "Val F1 Score"},
    "val/Classwise_F1_Score_3": {"title": "Baseline Recreation model on Cropland", "y-label": "Val F1 Score"},
    "val/Classwise_F1_Score_4": {"title": "Baseline Recreation model on Broadleaves", "y-label": "Val F1 Score"},
    "val/Classwise_F1_Score_5": {"title": "Baseline Recreation model on Conifers", "y-label": "Val F1 Score"},
    "val/Classwise_F1_Score_6": {"title": "Baseline Recreation model on Shrubland", "y-label": "Val F1 Score"},
    "val/Classwise_F1_Score_7": {"title": "Baseline Recreation model on Water", "y-label": "Val F1 Score"},
    "val/Classwise_F1_Score_8": {"title": "Baseline Recreation model on Wetlands", "y-label": "Val F1 Score"},
}
