#!/bin/bash -x
#SBATCH --job-name=TTsen4mapCropsUpdated+bs80+crop15+patch3+timepatch3+recreate+baseline
...
srun -l terratorch_patched fit \
        --config ./ViT-B_sen4map-crops-updated_bs80_crop15_patch3_timepatch3_Recreate_baseline.yaml \
        ${@}
        # --ckpt_path ...