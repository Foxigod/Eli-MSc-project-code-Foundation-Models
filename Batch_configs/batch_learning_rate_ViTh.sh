...
log_file="${log_dir}/learning_rate_ViTh_v2_repeatfailed_v4.log"
...
for lr in "${learning_rates[@]}"; do
    for seed in "${seeds[@]}"; do
        ...
        output=$(sbatch --job-name="lr_${lr}__seed_${seed}_ViTh_4nodes" ./submit_ViT-h_sen4map_bs4_crop15_resize224_patch14.sh \
