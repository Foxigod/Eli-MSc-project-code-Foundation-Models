...
log_file = Path("./logs_batched/learning_rate_PrithviV1_10seeds.log")
...
names = {
    ...
    "val/Classwise_F1_Score_0": {"title": "PrithviOS on Artificial land", "y-label": "Val F1 Score"},
    "val/Classwise_F1_Score_1": {"title": "PrithviOS on Bareland", "y-label": "Val F1 Score"},
    "val/Classwise_F1_Score_2": {"title": "PrithviOS on Grassland", "y-label": "Val F1 Score"},
    "val/Classwise_F1_Score_3": {"title": "PrithviOS on Cropland", "y-label": "Val F1 Score"},
    "val/Classwise_F1_Score_4": {"title": "PrithviOS on Broadleaves", "y-label": "Val F1 Score"},
    "val/Classwise_F1_Score_5": {"title": "PrithviOS on Conifers", "y-label": "Val F1 Score"},
    "val/Classwise_F1_Score_6": {"title": "PrithviOS on Shrubland", "y-label": "Val F1 Score"},
    "val/Classwise_F1_Score_7": {"title": "PrithviOS on Water", "y-label": "Val F1 Score"},
    "val/Classwise_F1_Score_8": {"title": "PrithviOS on Wetlands", "y-label": "Val F1 Score"},
}
