...
log_file="${log_dir}/learning_rate_crops_updated_ViTL-fp32.log"
...
for lr in "${learning_rates[@]}"; do
    for seed in "${seeds[@]}"; do
        ...
        output=$(sbatch --job-name="lr_${lr}__seed_${seed}_crops_updated_ViTL" ./submit_ViT-L-fp32_sen4map-crops-updated_bs10_crop15_resize224_patch16.sh \
