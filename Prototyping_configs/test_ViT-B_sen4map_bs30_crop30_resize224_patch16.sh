#!/bin/bash -x
#SBATCH --job-name=test+TTsen4map+bs30+crop30+resize224+patch16
...
srun -l terratorch_patched test \
        --config ./ViT-B_sen4map_bs30_crop30_resize224_patch16.yaml \
        --ckpt_path </DEFAULT_ROOT_DIR/lightning_logs/version_NUMBER/>/checkpoints/epoch=7.ckpt