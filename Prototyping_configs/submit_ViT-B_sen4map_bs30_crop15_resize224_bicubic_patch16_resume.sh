#!/bin/bash -x
#SBATCH --job-name=TTsen4map+bs30+crop15+resize224+bicubic+patch16+resume
...
srun -l terratorch_patched fit \
        --config ./ViT-B_sen4map_bs30_crop15_resize224_bicubic_patch16.yaml \
        --ckpt_path </DEFAULT_ROOT_DIR/lightning_logs/version_NUMBER/>/checkpoints/last.ckpt