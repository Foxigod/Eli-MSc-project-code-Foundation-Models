#!/bin/bash -x
#SBATCH --job-name=test+TTsen4map+ViT-L+tf32+bs10+crop15+resize224+patch16
...
srun -l terratorch_patched test \
        --config ./ViT-L-tf32_sen4map_bs10_crop15_resize224_patch16.yaml \
        --ckpt_path </DEFAULT_ROOT_DIR/lightning_logs/version_NUMBER/>/checkpoints/epoch=5.ckpt