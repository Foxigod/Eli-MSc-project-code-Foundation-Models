#!/bin/bash -x
#SBATCH --job-name=test+TTsen4map+bs25+crop15+resize224+patch16
...
srun -l terratorch_patched test \
        --config ./ViT-B_sen4map_bs30_crop14_resize224_patch16.yaml \
        --ckpt_path </DEFAULT_ROOT_DIR/lightning_logs/version_NUMBER/>/checkpoints/epoch=11.ckpt