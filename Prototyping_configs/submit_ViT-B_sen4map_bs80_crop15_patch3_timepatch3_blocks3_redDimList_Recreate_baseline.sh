#!/bin/bash -x
#SBATCH --job-name=TTsen4map+bs80+crop15+patch3+timepatch3+blocks3+redDimList+recreate+baseline
...
srun -l terratorch_patched fit \
        --config ./ViT-B_sen4map_bs80_crop15_patch3_timepatch3_blocks3_redDimList_Recreate_baseline.yaml \
        # --ckpt_path ...